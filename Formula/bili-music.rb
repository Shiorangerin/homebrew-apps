class BiliMusic < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Shiorangerin/BiliMusic/releases/download/v#{version}/bili-music-aarch64-apple-darwin.tar.gz"
      sha256 "bf13d813226413b2dd4b7dc959e37bd2873ebd49dd2395ff0ed1019ab2b7e85e"
    end
    on_intel do
      url "https://github.com/Shiorangerin/BiliMusic/releases/download/v#{version}/bili-music-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/Shiorangerin/BiliMusic/releases/download/v#{version}/bili-music-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "7808d97d08c9014a436495e0abaf2189105fa78411ac36d4a49e0674f0c7c8e1"
    end
    on_intel do
      url "https://github.com/Shiorangerin/BiliMusic/releases/download/v#{version}/bili-music-x86_64-unknown-linux-gnu.tar.gz"
